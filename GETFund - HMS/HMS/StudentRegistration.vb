...
Public Class StudentRegistration
    ...
    Dim allstudents(1000, 20) As String
    ...
    Private Function sendMessage(phoneNumber As String, student_name As String, roomN0 As String) As Boolean
        ...
        End Try
    End Function
    ''sending an api request to fetch the student details by reference number
    Private Sub sendAPIRequestByRefNumber(ReferenceNumber)
        Try
            ...
            Dim jsonResult = JsonConvert.DeserializeObject(Of Result)(raw)
            Dim studentInfo As StudentDetails = jsonResult.value

            ShowStudentDetails(studentInfo.surname + " " + studentInfo.othernames, studentInfo.indexnumber, studentInfo.awardedprogram, studentInfo.gender, studentInfo.level, studentInfo.contact1)
        Catch ex As Exception
            MessageBox.Show("Invalid Reference Number", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub

    ''private contructor to fill the details of the selected student into the form
    Private Sub ShowStudentDetails(name, indexNumber, program, gender, level, phone)
        txtname.Text = name
        txtindexno.Text = indexNumber
        txtphoneno.Text = phone.ToString()
        cmbprogramme.Text = program
        cmbgender.Text = gender
        cmblevel.Text = level
    End Sub
    ''instance of api request button click
    Private Sub APIRequestbtn_Click(sender As Object, e As EventArgs) Handles APIRequestbtn.Click
        If (StudentReferenceNumbertxt.Text.Length = 0) Then
            MessageBox.Show("Please enter the ReferenceNumber", "Reference Number Required", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    'Private Sub cmbgender_TextChanged(sender As Object, e As EventArgs) Handles cmbgender.TextChanged
    '    If My.Settings.AutoSuggestion = True Then
    '        txtRoom.Text = student.Room.Suggest(cmbgender.Text, Val(cmblevel.Text), Int(ComboBox1.Text))
    '    End If
    'End Sub
End Class
''instance of a student details model
Public Class StudentDetails

    Public Property indexnumber() As String
    Public Property awardedprogram() As String
    Public Property contact1() As String
    Public Property contact2() As String
    Public Property gender() As String
    Public Property level() As String
    Public Property firstProgram() As String
    ...
    Public Property admittedBy() As String
...
Public Class Result
    Public Property isSucessful() As Boolean

    Public Property value() As StudentDetails
