...
Public Class StudentRegistration
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If validId And validName And validProg And validGender And validLevel And validPhone And validEmail And _
    ...
    Private Function sendMessage(phoneNumber As String, student_name As String, roomN0 As String) As Boolean
        ...
        MESSAGE = "Hi, " + firstName +
                   " , Your Application for UENR New Hostel has been approved. You have been assigned to Room " + roomN0 +
                   ". Thank you"
